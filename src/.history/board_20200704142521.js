...
export default class Board extends React.Component { 
    ...
    render() { // renders 9 squares
      return (
        <div>
          {this.create_row(this.props.rows)} {/* creates the first row */}
          {this.create_row(this.props.rows+3)} {/* creates the second row */}
          {this.create_row(this.props.rows+6)} {/* creates the third row */}
        </div>
      );
    }
  }
