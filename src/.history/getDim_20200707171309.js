    ...
    render() {
      ...
      <div className = 'submission'>
        <form>
          <label>
            Board Size<br></br>
            <input name = "board" type="int" value={this.state.rows} onChange={this.handleInputChange} />           
          </label>
          <br />
          <label>
            <select name = "winning" value={this.state.winning} onChange={this.handleInputChange}>
